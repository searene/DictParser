...
var DetectEncoding = require("../DetectEncoding");
...
var DSLDictionary = (function (_super) {
    ...
    DSLDictionary.prototype.getEncoding = function (fileContents) {
        return __awaiter(this, void 0, void 0, function () {
            var encoding;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, DetectEncoding.detectEncodingByBOM(fileContents)];
                    case 1:
                        encoding = _a.sent();
                        return [2 /*return*/, encoding.isDetectionSuccessful ? encoding.encoding : 'utf8'];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        dictBinaryContents = _a.sent();
                        _a.label = 4;
                    case 4: return [4 /*yield*/, this.getEncoding(dictBinaryContents)];
                    case 5:
                        encoding = _a.sent();
                        dictContents = dictBinaryContents.toString(encoding);
                    ...
                    case 1:
                        ...
                        for (i = definitionStartingLineNumber; i < lines.length; i++) {
                            ...
                            if (line.trim().length != 0 && [" ", "\t"].indexOf(line.substring(0, 1)) == -1) {
                                indexList.push({ word: line, line: i });
                            }
                        }
        ...
        for (var i = 0; i < line.length; i++) {
            if (line.charAt(i) == '\\') {
                if (i == line.length - 1) {
                    ...
                    indexableWord += line.charAt(i) + line.charAt(i + 1);
                    i++;
                }
            }
