...
var LineReader = (function (_super) {
    ...
    LineReader.prototype.process = function () {
        var _this = this;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this._bufferReader.getEncodingStat(this._filePath)];
                    case 2:
                        encodingStat = _a.sent();
                        this._encoding = encodingStat.encoding;
                        dataProcessTotally = encodingStat.posAfterBom;
                        return [4 /*yield*/, this._bufferReader.read(this._filePath, dataProcessTotally, this._len)];
                    case 3:
                        bufferRead = _a.sent();
                        data = bufferRead;
                        i = 1;
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, this._bufferReader.read(this._filePath, encodingStat.posAfterBom + i * this._len, this._len)];
                    case 5:
                        // read 64KB
                        bufferRead = _a.sent();
    ...
    LineReader.register = function (ext, BufferReaderConstructor) {
...
LineReader.register('.dsl', BufferReader_1.SimpleBufferReader);
LineReader.register('.dz', BufferReader_1.DzBufferReader);
