...
var DictionaryFinder = (function () {
    ...
    DictionaryFinder.register = function (dictName, Dictionary) {
     ...
     */
    DictionaryFinder.prototype.scan = function (dir, dbPath) {
        if (dbPath === void 0) { dbPath = constant_1.DEFAULT_DB_PATH; }
        return __awaiter(this, void 0, void 0, function () {
            var dictMapList, files, _i, files_1, file, ext, _a, _b, _c, dictName, dictionary, resource, dictStats;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        ...
                        _a = 0, _b = Array.from(DictionaryFinder._dictionaries.entries());
                        _d.label = 3;
                    case 3:
                        if (!(_a < _b.length)) return [3 /*break*/, 7];
                        _c = _b[_a], dictName = _c[0], dictionary = _c[1];
                        if (!(dictionary.dictionarySuffixes.indexOf(ext) > -1)) return [3 /*break*/, 6];
                        return [4 /*yield*/, this.getResource(file.filePath, files.map(function (file) { return file.filePath; }), dictionary.resourceHolderSuffixes, dictionary.resourceFileSuffixes)];
                    case 4:
                        resource = _d.sent();
                        return [4 /*yield*/, dictionary.getDictionaryStats(file.filePath)];
                    case 5:
                        dictStats = _d.sent();
    ...
    Object.defineProperty(DictionaryFinder, "dictionaries", {
        get: function () {
...
DictionaryFinder._dictionaries = new Map();
exports.DictionaryFinder = DictionaryFinder;
DictionaryFinder.register('dsl', DSLDictionary_1.DSLDictionary);
