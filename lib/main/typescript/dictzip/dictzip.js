...
(function (GLOBAL) {
    ...
    var DictZipFile = (function () {
        var cls = function (f, gunzip_func) {
            var dzfile = f, gunzip = gunzip_func, verified = false, gzip_header, ver, chlen = 0, chcnt = 0, chunks = [];
            ...
            this.read = function (pos, len) {
                return new Promise(function (resolve, reject) {
                    ...
                    offset = pos - firstchunk * chlen, finish = offset + len, reader = new FileReader();
                    reader.onload = function (e) {
                        var out_buffer = new ArrayBuffer(0), in_buffer = e.target.result;
                    ...
                    reader.readAsArrayBuffer(dzfile.slice(gzip_header["LENGTH"] + chunks[firstchunk][0], gzip_header["LENGTH"] + chunks[lastchunk][0] + chunks[lastchunk][1]));
                });
            };
        };
        return cls;
