...
var Dictionary = (function () {
    ...
    Dictionary.prototype.loadIndex = function (dictPath, dbFile) {
        if (dbFile === void 0) { dbFile = constant_1.DEFAULT_DB_PATH; }
        return __awaiter(this, void 0, void 0, function () {
            var dbContents, dbJson, indexList, _i, dbJson_1, dict;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        indexList = [];
                        for (_i = 0, dbJson_1 = dbJson; _i < dbJson_1.length; _i++) {
                            dict = dbJson_1[_i];
    ...
    Object.defineProperty(Dictionary.prototype, "dictName", {
        get: function () {
