 ...
 */
function detectEncodingByBOM(filePath) {
    return __awaiter(this, void 0, void 0, function () {
        var fd, bom;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fsp.open(filePath, 'r')];
                case 1:
                    fd = _a.sent();
                    bom = Buffer.alloc(4);
                    return [4 /*yield*/, fsp.read(fd, bom, 0, 4, 0)];
                case 2:
                    _a.sent();
...
function getPosAfterBOM(filePath) {
    return __awaiter(this, void 0, void 0, function () {
        var encodingDetectionResult, isDetected, encoding;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, detectEncodingByBOM(filePath)];
                case 1:
                    encodingDetectionResult = _a.sent();
