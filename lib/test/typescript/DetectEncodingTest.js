...
describe('detect encoding test', function () {
    ...
    it("#detectEncodingInBuffer", function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                    _a = DetectEncoding_2.detectEncodingInBuffer;
                    return [4 /*yield*/, fsp.readFile(utf32be_file)];
                case 1: return [4 /*yield*/, _a.apply(void 0, [_g.sent()])];
                case 2:
                    utf32be_encoding = _g.sent();
                    _b = DetectEncoding_2.detectEncodingInBuffer;
                    return [4 /*yield*/, fsp.readFile(utf32le_file)];
                case 3: return [4 /*yield*/, _b.apply(void 0, [_g.sent()])];
                case 4:
                    utf32le_encoding = _g.sent();
                    _c = DetectEncoding_2.detectEncodingInBuffer;
                    return [4 /*yield*/, fsp.readFile(utf16be_file)];
                case 5: return [4 /*yield*/, _c.apply(void 0, [_g.sent()])];
                case 6:
                    utf16be_encoding = _g.sent();
                    _d = DetectEncoding_2.detectEncodingInBuffer;
                    return [4 /*yield*/, fsp.readFile(utf16le_file)];
                case 7: return [4 /*yield*/, _d.apply(void 0, [_g.sent()])];
                case 8:
                    utf16le_encoding = _g.sent();
                    _e = DetectEncoding_2.detectEncodingInBuffer;
                    return [4 /*yield*/, fsp.readFile(utf8withBom_file)];
                case 9: return [4 /*yield*/, _e.apply(void 0, [_g.sent()])];
                case 10:
                    utf8withBom_encoding = _g.sent();
                    _f = DetectEncoding_2.detectEncodingInBuffer;
                    return [4 /*yield*/, fsp.readFile(utf8_file)];
                case 11: return [4 /*yield*/, _f.apply(void 0, [_g.sent()])];
                case 12:
                    utf8_encoding = _g.sent();
                    chai_1.assert.deepEqual(utf32be_encoding, { encoding: DetectEncoding_1.UTF_32_BE, posAfterBom: 4 });
                    chai_1.assert.deepEqual(utf32le_encoding, { encoding: DetectEncoding_1.UTF_32_LE, posAfterBom: 4 });
                    chai_1.assert.deepEqual(utf16be_encoding, { encoding: DetectEncoding_1.UTF_16_BE, posAfterBom: 2 });
                    chai_1.assert.deepEqual(utf16le_encoding, { encoding: DetectEncoding_1.UTF_16_LE, posAfterBom: 2 });
                    chai_1.assert.deepEqual(utf8withBom_encoding, { encoding: DetectEncoding_1.UTF_8_BOM, posAfterBom: 3 });
                    chai_1.assert.deepEqual(utf8_encoding, { encoding: DetectEncoding_1.UTF_8, posAfterBom: 0 });
                    return [2 /*return*/];
            }
        });
    }); });
