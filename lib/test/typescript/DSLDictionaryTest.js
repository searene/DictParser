...
describe('DSLDictionaryTest', function () {
    ...
    it("#buildIndex", function () { return __awaiter(_this, void 0, void 0, function () {
        var dzFile, dictionary, indexList;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    dzFile = path.join(constant_1.ROOT_PATH, 'src/main/resources/dsl/sample.dsl');
                    dictionary = new DSLDictionary_1.DSLDictionary();
                    return [4 /*yield*/, dictionary.buildIndex(dzFile)];
                case 1:
                    indexList = _a.sent();
                    chai_1.assert.deepEqual(indexList, [
