...
export class DSLIndexManager extends IndexManager {
    ...
    public buildIndex(): Promise<void> {
        let pos = 0;
        let remaining = '';
        let inputStream = fsp.createReadStream(this._dictFile);
        return new Promise<void>((resolve, reject) => {
            ...
            inputStream.on('end', () => {
                ...
                this.addIndexToDb(this.dictId, this._dictFile, this.indexArray)
                    .then(() => {resolve()})
